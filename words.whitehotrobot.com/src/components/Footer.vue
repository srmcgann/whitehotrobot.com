...
export default {
  ...
  methods: {
    launchEmail () {
      location.href = 'mailto:whitehotrobot@gmail.com?subject=I%20come%20from%20the%20Internet!&body=I%20have%20a%20comment%20or%20concern%20about%20the%20website(words.whitehotrobot.com)...'
    },
    launchPage (loc) {
...
.footerBar{
  ...
  background: linear-gradient(90deg, #001c, #0046);
