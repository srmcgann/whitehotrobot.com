<template>
  <div class="controls" v-if="!state.showUploadModal" :class="{'shortControlsContainer':!state.showControls}">
    <div class="controlsWorkingSpace">
      <div @click="state.toggleShowControls" title="show additional controls [ESC]" :class="{'showImg':!state.showControls, 'hideImg': state.showControls, 'bump': state.mode=='post'}" style="margin-top:-70px;"></div>
