        ...
        <div v-if="state.showControls">
          <div class="navContainer">
            <div v-if="state.mode !== 'post'" class="advancedControls">
              ...
              <select v-if="state.loggedin && state.mode != 'post'" style="font-size: 16px;margin-left: 20px;vertical-align: top;margin-top: 4px;border: 1px solid #8ff4;display: inline-block;position: relative;" v-model="state.maxResultsPerPage" @input="updateUserPrefs('wordsPostsPerPage')">
