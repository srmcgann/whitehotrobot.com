...
null===K&&850>$(window).height())&&$(document.body).addClass("minimal");bw.tablet&&$("#viewport").attr("content","width=1600, initial-scale=1.0, user-scalable=1");$(document).ready(function(){l.init()})}}
