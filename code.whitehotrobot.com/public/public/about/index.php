...
<html>
  <head>
    ...
    <meta property="og:url" content="https://code.dweet.net/about"/>
    ...
    <div class="main">
      <div class="maintext">
        ...
        <div class="linkbox">
          ...
          <a href="https://code.dweet.net" target="_blank">demos / code with videos</a><br>
          <a href="https://audiocloud.dweet.net" target="_blank">audiocloud (music library)</a><br>
          <a href="https://games.dweet.net" target="_blank">free browser games by the user-community</a><br>
